    ...
    if (exprent.type == Exprent.EXPRENT_FUNCTION) {
      ...
      switch (fexpr.getFuncType()) {
        case FunctionExprent.FUNCTION_BOOL_NOT:
          ...
          break;
        case FunctionExprent.FUNCTION_EQ:case FunctionExprent.FUNCTION_NE:case FunctionExprent.FUNCTION_GT:
      ...
      case Exprent.EXPRENT_FUNCTION:
        ...
        switch (fexpr.getFuncType()) {
          case FunctionExprent.FUNCTION_XOR:
            ...
            break;
          case FunctionExprent.FUNCTION_EQ: case FunctionExprent.FUNCTION_NE:
          ...
          case FunctionExprent.FUNCTION_IIF:
            ...
            break;
          case FunctionExprent.FUNCTION_LCMP:case FunctionExprent.FUNCTION_FCMPL:case FunctionExprent.FUNCTION_FCMPG:case FunctionExprent.FUNCTION_DCMPL:case FunctionExprent.FUNCTION_DCMPG:
      ...
      if (fexpr.getFuncType() == FunctionExprent.FUNCTION_BOOL_NOT) {
        ...
        if (param.type == Exprent.EXPRENT_FUNCTION) {
          ...
          switch (ftype) {
            ...
            case FunctionExprent.FUNCTION_CADD:case FunctionExprent.FUNCTION_COR: {
            ...
            case FunctionExprent.FUNCTION_EQ:case FunctionExprent.FUNCTION_NE:
              canSimplify = true;
            case FunctionExprent.FUNCTION_LT:case FunctionExprent.FUNCTION_GE:case FunctionExprent.FUNCTION_GT:case FunctionExprent.FUNCTION_LE:
              if (!canSimplify) {
