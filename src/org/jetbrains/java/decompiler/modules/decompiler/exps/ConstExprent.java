...
public class ConstExprent extends Exprent {
  ...
  public TextBuffer toJava(int indent, BytecodeMappingTracer tracer) {
    ...
    switch (constType.getType()) {
      case CodeConstants.TYPE_BOOLEAN: return new TextBuffer(Boolean.toString((Integer)value != 0));
      ...
      case CodeConstants.TYPE_BYTE: return  new TextBuffer(value.toString());
      case CodeConstants.TYPE_BYTECHAR:case CodeConstants.TYPE_SHORT:
      ...
      case CodeConstants.TYPE_SHORTCHAR:case CodeConstants.TYPE_INT:
      ...
      case CodeConstants.TYPE_DOUBLE:
        ...
        return new TextBuffer(value.toString());
      case CodeConstants.TYPE_NULL: return new TextBuffer("null");
  ...
  public boolean hasBooleanValue() {
    switch (constType.getType()) {
      case CodeConstants.TYPE_BOOLEAN:case CodeConstants.TYPE_CHAR:case CodeConstants.TYPE_BYTE:case CodeConstants.TYPE_BYTECHAR:case
        CodeConstants.TYPE_SHORT:case CodeConstants.TYPE_SHORTCHAR:case CodeConstants.TYPE_INT:
  ...
  public boolean hasValueOne() {
    switch (constType.getType()) {
      case CodeConstants.TYPE_BOOLEAN:case CodeConstants.TYPE_CHAR:case CodeConstants.TYPE_BYTE:case CodeConstants.TYPE_BYTECHAR:case
        CodeConstants.TYPE_SHORT:case CodeConstants.TYPE_SHORTCHAR:case CodeConstants.TYPE_INT:return (Integer)value == 1;
      case CodeConstants.TYPE_LONG:return ((Long)value).intValue() == 1;
      case CodeConstants.TYPE_DOUBLE:return ((Double)value).intValue() == 1;
      case CodeConstants.TYPE_FLOAT:return ((Float)value).intValue() == 1;
  ...
  public static ConstExprent getZeroConstant(int type) {
    switch (type) {
      case CodeConstants.TYPE_INT:return new ConstExprent(VarType.VARTYPE_INT, 0, null);
      case CodeConstants.TYPE_LONG:return new ConstExprent(VarType.VARTYPE_LONG, 0L, null);
      case CodeConstants.TYPE_DOUBLE:return new ConstExprent(VarType.VARTYPE_DOUBLE, 0d, null);
      case CodeConstants.TYPE_FLOAT:return new ConstExprent(VarType.VARTYPE_FLOAT, 0f, null);
