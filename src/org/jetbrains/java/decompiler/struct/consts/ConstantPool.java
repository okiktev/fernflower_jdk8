...
public class ConstantPool implements NewClassNameBuilder {
    ...
    for (int i = 1; i < size; i++) {
      ...
      switch (tag) {
        case CodeConstants.CONSTANT_Utf8:
          pool.add(new PrimitiveConstant(CodeConstants.CONSTANT_Utf8, in.readUTF()));break;
        case CodeConstants.CONSTANT_Integer:
          pool.add(new PrimitiveConstant(CodeConstants.CONSTANT_Integer, Integer.valueOf(in.readInt())));break;
        case CodeConstants.CONSTANT_Float:
          pool.add(new PrimitiveConstant(CodeConstants.CONSTANT_Float, in.readFloat()));break;
        ...
        case CodeConstants.CONSTANT_Double:
          ...
          i++;
          break;
        case CodeConstants.CONSTANT_Class:case CodeConstants.CONSTANT_String:case CodeConstants.CONSTANT_MethodType:case CodeConstants.CONSTANT_Module:case CodeConstants.CONSTANT_Package:
        ...
        case CodeConstants.CONSTANT_NameAndType:
          ...
          nextPass[0].set(i);
          break;
        case CodeConstants.CONSTANT_Fieldref:case CodeConstants.CONSTANT_Methodref:case CodeConstants.CONSTANT_InterfaceMethodref:case CodeConstants.CONSTANT_Dynamic:case CodeConstants.CONSTANT_InvokeDynamic:
          pool.add(new LinkConstant(tag, in.readUnsignedShort(), in.readUnsignedShort()));
          nextPass[1].set(i);
          break;
  ...
  public static void skipPool(DataInputFullStream in) throws IOException {
    ...
    for (int i = 1; i < size; i++) {
      switch (in.readUnsignedByte()) {
        case CodeConstants.CONSTANT_Utf8: in.readUTF();break;
        case CodeConstants.CONSTANT_Integer:case CodeConstants.CONSTANT_Float:case CodeConstants.CONSTANT_Fieldref:case CodeConstants.CONSTANT_Methodref:case CodeConstants.CONSTANT_InterfaceMethodref:case CodeConstants.CONSTANT_NameAndType:case CodeConstants.CONSTANT_Dynamic:case CodeConstants.CONSTANT_InvokeDynamic:
          in.discard(4);
          break;
        case CodeConstants.CONSTANT_Long:case CodeConstants.CONSTANT_Double:
          in.discard(8);
          i++;
          break;
        case CodeConstants.CONSTANT_Class:case CodeConstants.CONSTANT_String:case CodeConstants.CONSTANT_MethodType: in.discard(2);break;
        case CodeConstants.CONSTANT_MethodHandle: in.discard(3);break;
      }
    }
  }
  ...
  String repeat(String token, int count) {
